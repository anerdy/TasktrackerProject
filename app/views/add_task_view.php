        ...
        <div class="col-md-6">
            ...
            <form action="#" method="post" enctype="multipart/form-data" >
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" aria-describedby="nameHelp" placeholder="Имя" v-model="name" >
                ...
                <br>
                <button class="btn btn-outline-secondary" @click.prevent="preview()" >Предварительный просмотр</button>
