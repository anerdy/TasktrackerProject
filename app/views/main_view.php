            ...
            <p>
                <?php if ( ! empty($data['tasks']) ): ?>
                    <table class="table">
                        ...
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col"><a href="?order=name&sort=<?= $data['filter']['sort'] == 'asc' ? 'desc' : 'asc'; ?>">Имя</a></th>
                            <th scope="col"><a href="?order=email&sort=<?= $data['filter']['sort'] == 'asc' ? 'desc' : 'asc'; ?>">Email</a></th>
                            <th scope="col"><a href="?order=status&sort=<?= $data['filter']['sort'] == 'asc' ? 'desc' : 'asc'; ?>">Статус</a></th>
